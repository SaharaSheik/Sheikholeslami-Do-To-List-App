...
public class HelpController implements Initializable {
    ...
    private void loadHelp(){
        String help = "1. This Application will automatically load all the previously saved items from the external storage during startup.\n\n" +
                "2. user can add an item to the list by filling out an item description and an item due date and pressing the \"+\" button on the screen.\n\n" +
                "3. User can add an item as \"complete\" or \"incomplete\" by clicking on the checkMark button\n\n "+
                "4. User can remove an item from the list by clicking on the  \"-\" button\n\n" +
                "5. User can edit an item's description by clicking on \"edit\" button annotated by the \"pen\" symbol.\n\n" +
                ...
                "8. User can sort list by due date by clicking the sort button at the bottom of the screen.\n\n"+
